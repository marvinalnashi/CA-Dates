...
class ActivitiesUserComponent extends Component {
    ...
    render() {
        ...
        return (
            <TouchableFeedback onPress={() => navigation.navigate('ActivitiesSendRequest', {activities: params.activities, user: item})}>
...
export default ActivitiesUserComponent;
