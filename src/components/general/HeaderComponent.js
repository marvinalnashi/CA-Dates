...
class HeaderComponent extends React.PureComponent {
    render() {
        const {theme, title, titleStyle, leftView, middleView, rightView, onLeftPress, type, currentIndex} = this.props;
                            ...
                            currentIndex === 1
                                ...
                                : <TouchableFeedback onPress={()=>onLeftPress(2)}>
                                    <View style={[styles.buttonView, {width: null, paddingHorizontal: 10}]}>
                                        <Text style={{fontSize: 14, fontWeight: '600', color: theme.blueColor}}>Previous</Text>
                                    </View>
                                </TouchableFeedback>
                        }
                        ...
                        </View>
                        {
                            getIndex > 2
                                ? <TouchableFeedback onPress={()=>onLeftPress(3)}>
                                    <View style={[styles.buttonView, {width: null, paddingHorizontal: 10}]}>
                                        <Text style={{fontSize: 14, fontWeight: '600', color: theme.blueColor}}>Skip</Text>
                                    </View>
                                </TouchableFeedback>
                                : <View style={[styles.buttonView]} />
                        }
