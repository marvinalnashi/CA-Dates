...
class MyProfileScreen extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            party: regex.isEmpty(user.party) ? '' : user.party,
            ...
            kidsStatus: regex.isEmpty(user.kidsStatus) ? '' : user.kidsStatus,
    ...
    render() {
        ...
        const {isEdit, name, DoB, bio, photos, height, party, gender, sexuality, personality, education, maritalStatus, lookingFor, religion, kidsStatus, drinkingStatus, smokingStatus, eatingStatus} = this.state;
