...
import {Transparent} from '../../../themes/constants';
...
class OtherProfileScreen extends Component {
    ...
    render() {
        ...
        const {instagramPhotos, name, DoB, bio, photos, height, party, gender, sexuality, personality, education, maritalStatus, lookingFor, religion, kidsStatus, drinkingStatus, smokingStatus, eatingStatus, location} = this.state;
                    ...
                    <View style={{borderTopLeftRadius: 20, borderTopRightRadius: 20}}>
...

                        {
                            photos.length > 0 && <View style={[styles.commonView, {backgroundColor: theme.backgroundColor, borderBottomWidth: 0}]}>
                                <Text style={[styles.photoText, {color: theme.primaryColor}]}>All Photos</Text>
                                <Text style={[styles.commonText, {color: theme.blueColor}]} onPress={() => navigation.navigate('AllPhotos', {photos})}>See All</Text>
                            </View>
                        }
                        {
...

                        {
                            instagramPhotos.length > 0 && <View style={[styles.commonView, {backgroundColor: theme.backgroundColor, borderBottomWidth: 0}]}>
                                ...
                                <Text style={[styles.commonText, {color: theme.blueColor}]} onPress={() => navigation.navigate('AllPhotos')}>See All</Text>
                            </View>
                        }
                        {
                        ...
                        {this.renderItemView('Partying', party, 2)}
                        ...
                        {this.renderItemView('Desired kids', kidsStatus, 10)}
                        {this.renderItemView('Drinking', drinkingStatus, 11)}
                        {this.renderItemView('Smoking', smokingStatus, 12)}
                        {this.renderItemView('Eating', eatingStatus, 13)}
