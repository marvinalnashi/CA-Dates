...
class RegistrationStepScreen extends Component {
    ...
    constructor(props) {
        ...
        this.getData = {
            ...
            party: regex.isEmpty(params.party) ? '' : params.party,
            ...
            kidsStatus: regex.isEmpty(params.kidsStatus) ? '' : params.kidsStatus,
    ...
    storeDataInFirestore = (index, data) => {
        ...
        if (index === 1)
           ...
           if (Boolean(data.DoB))
            ...
            parameter = (regex.isEmpty(data)) ? {kidsStatus: '', drinkingStatus: '', smokingStatus: '', eatingStatus: ''} : data;
        }
        ...
        return (
            <View style={[styles.container, {backgroundColor: theme.container.backgroundColor}]}>
                ...
                <View style={[styles.inner ,{backgroundColor: theme.subSecondaryColor}]}>
                    <Animated.View style={[styles.outer,{width: `${progressStatus}%`, backgroundColor: theme.blueColor}]}/>
                </View>
